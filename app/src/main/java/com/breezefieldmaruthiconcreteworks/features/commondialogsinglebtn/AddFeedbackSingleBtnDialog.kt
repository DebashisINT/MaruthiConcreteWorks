package com.breezefieldmaruthiconcreteworks.features.commondialogsinglebtn
...
import com.breezefieldmaruthiconcreteworks.app.domain.ShopVisitCompetetorModelEntity
import com.breezefieldmaruthiconcreteworks.app.domain.VisitRemarksEntity
...
import com.breezefieldmaruthiconcreteworks.features.addshop.presentation.ProspectListDialog
import com.breezefieldmaruthiconcreteworks.features.dashboard.presentation.DashboardActivity
import com.breezefieldmaruthiconcreteworks.features.dashboard.presentation.VisitMultiContactAdapter
...
import com.breezefieldmaruthiconcreteworks.features.nearbyshops.model.ProsListResponseModel
...
//                        mListener.onOkClick(tv_remarks_dropdown.text.toString().trim(), nextVisitDate, filePath,et_approxvalue_name.text.toString(),ProsId)
            ...
            audioRecRoot.id,et_audioNW.id ->{
                ...
                audioFileNW = File("/data/user/0/com.breezefieldmaruthiconcreteworks/files", "recorded_audio${System.currentTimeMillis()}.mp3")
