package com.breezefieldmaruthiconcreteworks.features.logoutsync.presentation
...
import com.breezefieldmaruthiconcreteworks.app.utils.Toaster
...
import com.breezefieldmaruthiconcreteworks.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezefieldmaruthiconcreteworks.features.billing.api.AddBillingRepoProvider
import com.breezefieldmaruthiconcreteworks.features.billing.model.AddBillingInputParamsModel
...
import com.breezefieldmaruthiconcreteworks.features.dashboard.presentation.ReasonDialog
...
import com.breezefieldmaruthiconcreteworks.features.document.model.AddEditDocumentInputParams
import com.breezefieldmaruthiconcreteworks.features.document.model.DocumentAttachmentModel
...
import com.breezefieldmaruthiconcreteworks.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
...
import com.breezefieldmaruthiconcreteworks.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezefieldmaruthiconcreteworks.features.orderhistory.model.*
...
import com.breezefieldmaruthiconcreteworks.features.quotation.model.AddQuotInputModel
import com.breezefieldmaruthiconcreteworks.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldmaruthiconcreteworks.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezefieldmaruthiconcreteworks.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezefieldmaruthiconcreteworks.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezefieldmaruthiconcreteworks.features.timesheet.model.AddTimeSheetInputModel
import com.breezefieldmaruthiconcreteworks.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezefieldmaruthiconcreteworks.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezefieldmaruthiconcreteworks.features.viewAllOrder.model.AddOrderInputProductList
...
import com.breezefieldmaruthiconcreteworks.MonitorService
import com.breezefieldmaruthiconcreteworks.MySingleton
import com.breezefieldmaruthiconcreteworks.app.AlarmReceiver
import com.breezefieldmaruthiconcreteworks.features.addshop.model.*
import com.breezefieldmaruthiconcreteworks.features.addshop.model.assigntopplist.AddShopUploadImg
import com.breezefieldmaruthiconcreteworks.features.addshop.presentation.ShopExtraContactReq
import com.breezefieldmaruthiconcreteworks.features.addshop.presentation.multiContactRequestData
...
import com.breezefieldmaruthiconcreteworks.features.dashboard.presentation.model.AudioSyncModel
...
import com.breezefieldmaruthiconcreteworks.features.login.model.GetConcurrentUserResponse
...
import com.breezefieldmaruthiconcreteworks.features.orderITC.SyncDeleteOpptL
...
import com.breezefieldmaruthiconcreteworks.features.orderITC.SyncOpptProductL
import com.breezefieldmaruthiconcreteworks.features.orderITC.SyncOrd
import com.breezefieldmaruthiconcreteworks.features.orderITC.SyncOrdProductL
import com.breezefieldmaruthiconcreteworks.features.performance.model.Gps_status_list
import com.breezefieldmaruthiconcreteworks.features.performance.model.UpdateGpsInputListParamsModel
import com.breezefieldmaruthiconcreteworks.features.returnsOrder.ReturnProductList
import com.breezefieldmaruthiconcreteworks.features.returnsOrder.ReturnRequest
import com.breezefieldmaruthiconcreteworks.features.viewAllOrder.model.NewOrderSaveApiModel
import com.breezefieldmaruthiconcreteworks.features.viewAllOrder.model.NewStockSync
                                 ...
                                 doAsync {
                                     ...
                                     uiThread {
                                         ...
                                         try {
                                             ...
                                             var audFile = File("/data/user/0/com.breezefieldmaruthiconcreteworks/files", fileName)
                                             audFile.delete()
                                         }catch (ex:Exception){
                                             ex.printStackTrace()
                                         }
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldmaruthiconcreteworkslogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldmaruthiconcreteworkslogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldmaruthiconcreteworkslogsample/log.zip").path);
