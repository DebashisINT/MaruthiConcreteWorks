...
import com.breezefieldmaruthiconcreteworks.app.utils.AppUtils.Companion.changeAttendanceDateFormatToCurrent
import com.breezefieldmaruthiconcreteworks.app.utils.FTStorageUtils
import com.breezefieldmaruthiconcreteworks.app.utils.NotificationUtils
...
import com.breezefieldmaruthiconcreteworks.features.addshop.model.AssignedToShopListResponseModel
import com.breezefieldmaruthiconcreteworks.features.addshop.model.QuestionSubmit
import com.breezefieldmaruthiconcreteworks.features.addshop.model.UpdateAddrReq
import com.breezefieldmaruthiconcreteworks.features.addshop.model.UpdateAddressShop
...
import com.breezefieldmaruthiconcreteworks.features.addshop.presentation.*
...
import com.breezefieldmaruthiconcreteworks.features.marketing.api.marketingcategorylist.MarketingCatListRepoProvider
import com.breezefieldmaruthiconcreteworks.features.marketing.model.MarketingCategoryListResponse
...
import com.breezefieldmaruthiconcreteworks.features.nearbyshops.model.StageListResponseModel
...
import com.breezefieldmaruthiconcreteworks.features.shopdetail.presentation.AddCollectionDialog
...
//                            val uri = Uri.fromFile(file)
                ...
                val path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString() +"/breezefieldmaruthiconcreteworksApp/SHOPDtls/"
                var pathNew = ""
                val dir = File(path)
                if (!dir.exists()) {
                    dir.mkdirs()
